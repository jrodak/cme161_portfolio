...
Boid.prototype.set_parameters = function() {
    ...
    **/
    ...
    if(this.radius === 0) 
        console.log('Action Required: You need to set a boid radius.'); // delete this line
...
Boid.prototype.create_geometry = function() {
    ...
    **/
    ...
    if(typeof(this.geometry) == 'undefined')
        console.log('Action Required: You need to set a boid geometry.'); // delete this line
};
...
Boid.prototype.create_material = function() {
    ...
    **/
    ...
    if(typeof(this.material) == 'undefined') 
        console.log('Action Required: You need to set a boid material.'); // delete this line
};
...
Boid.prototype.create_mesh = function() {
    ...
    **/
    ...
    if(typeof(this.mesh) == 'undefined')
        console.log('Action Required: You need to set a boid mesh.');// delete this line
    ...
    **/
    ...
    if(typeof(this.mesh) != 'undefined' && this.mesh.position.x === 0 && this.mesh.position.y === 0 && this.mesh.position.z === 0)
        console.log('Action Required: You need to set the mesh position.'); // delete this line
};
...
Boid.prototype.update_mesh = function() {  
    ...
    **/
    ...
    this.mesh.position.set(this.position.x, this.position.y, this.position.z);
    if(typeof(this.mesh) != "undefined" && this.mesh.position.x === 0 && this.mesh.position.y === 0 && this.mesh.position.z === 0)
        console.log('Action Required: You need to update the mesh position.'); // delete this line
    ...
    **/
    ...
    this.mesh.material.color.setHSL( 0.8, momentum/this.range_momentum * 1.1, momentum/this.range_momentum * 0.4);
};